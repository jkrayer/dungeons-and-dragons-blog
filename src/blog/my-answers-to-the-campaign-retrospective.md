...
- [General Refresher](#general-refresher)
  - [On a scale of 1-5, please rate your level of enjoyment for the following Pillars of D\&D.](#on-a-scale-of-1-5-please-rate-your-level-of-enjoyment-for-the-following-pillars-of-dd)
  - [On a scale of 1-5, please rate your level of enjoyment for the following common elements of a D\&D Session.](#on-a-scale-of-1-5-please-rate-your-level-of-enjoyment-for-the-following-common-elements-of-a-dd-session)
  - [I enjoy the following styles of adventure (check all that apply).](#i-enjoy-the-following-styles-of-adventure-check-all-that-apply)
  - [I enjoy the following styles of play (check all that apply).](#i-enjoy-the-following-styles-of-play-check-all-that-apply)
  - [Side quests are…](#side-quests-are)
  - [When it comes to character-driven quests for other player characters and their backstories, I…](#when-it-comes-to-character-driven-quests-for-other-player-characters-and-their-backstories-i)
  - [Please rate campaign lengths from 1 to 5](#please-rate-campaign-lengths-from-1-to-5)
  - [Please rate geographic focus from 1-5](#please-rate-geographic-focus-from-1-5)
- [Setting](#setting)
  - [Rate the following types of setting 1-5](#rate-the-following-types-of-setting-1-5)
  - [Rate the following published D\&D settings (skip the ones you don't know)](#rate-the-following-published-dd-settings-skip-the-ones-you-dont-know)
  - [When starting a new campaign in a new setting you may receive a setting guide. If you received such a document…](#when-starting-a-new-campaign-in-a-new-setting-you-may-receive-a-setting-guide-if-you-received-such-a-document)
  - [A setting guide should contain the following information](#a-setting-guide-should-contain-the-following-information)
- [Character Creation and Motivation](#character-creation-and-motivation)
  - [Character Creation](#character-creation)
  - [Starting Level](#starting-level)
  - [If you answered "I'd prefer to continue the adventures of a previous character," name the character(s).](#if-you-answered-id-prefer-to-continue-the-adventures-of-a-previous-character-name-the-characters)
  - [Ability Score Generation](#ability-score-generation)
  - [I select race because…](#i-select-race-because)
  - [New characters sometimes have backstories](#new-characters-sometimes-have-backstories)
  - [New characters may start with connections to the setting](#new-characters-may-start-with-connections-to-the-setting)
  - [As my character develops I like to](#as-my-character-develops-i-like-to)
  - [As a player I like to](#as-a-player-i-like-to)
...
**Combat:** I strongly prefer the faster combat of TSR era D&D to the more involved combat of <abbr title="Wizards of the Coast">WOTC</abbr> era D&D.
...
1. If the game world is filled with people roughly analogous to medieval people then the mere sight of a monstrous PC (i.e. Tiefling) should cause the torches to be lit and the pitchforks to be gathered.
2. The players want magic shops so they can trade in the magic items they found for the magic items they want.
   1. This removes the need for players to use found items creatively.
   2. This defeats the DM seeding loot with items that will be useful in the future.
3. The players like being powerful but they're less than thrilled that the world around them is commensurately more powerful.
4. The players like being powerful but the world around them stays constrained removing the challenge and therefore fun from the game.
5. The players want some other rules restriction lifted (i.e. class and level limits) in order to realize a personal concept without care for its impact on setting which the DM may hold as precious.

It may also be that some set of rules does high-fantasy better than some other set of rules. For instance TSR era D&D places restictions on elves and dwarves because they start with special "powers" like infravsion where <abbr title="Wizards of the Coast">WOTC</abbr> era D&D removes those restrictions and gives humans special starting "powers" as well. While I think the "anyone can be anything" philosophy contributes to the utter blandness of <abbr title="Wizards of the Coast">WOTC</abbr> era D&D I can't deny that it makes for better "high-fantasy."
...
### Side quests are&hellip;

I like providing side-quests as both a temptation and break from the main quest line.

### When it comes to character-driven quests for other player characters and their backstories, I&hellip;
...
**A series of episodic adventures&hellip;** This would also be a lot of fun. There's a stack of TSR adventures and some third party that I'd love to run.

**A series of short games &hellip;** I'd prefer to save this style of game for testing other game systems.
...
**Forgotten Realms:** I like the Realms circa the <a href="https://acdn.mitiendanube.com/stores/002/474/783/products/img_20230615_1848335711-9af4e343d6ea1fc80916868666085553-640-0.jpg" target="_blank">gray box</a>/<a href="https://www.shopontheborderlands.co.uk/wp-content/uploads/2014/01/DSC04549-1-1000x665.jpg" target="_blank">Forgotten Realms Adventures</a>.
...
### When starting a new campaign in a new setting you may receive a setting guide. If you received such a document&hellip;
